...
def simple_test():
    try:
        ...
        # Ez most már a TELJES lista, amit a Google könyvtára megkövetel
        creds_dict = {
        ...
        # Írás az első sorba
        sheet.update('A1:J1', [list(range(1, 11))])
        
        return "✅ NA VÉGRE! Sikerült!"

    except Exception as e:
        return f"❌ Még mindig hiba: {str(e)}"

# UI
st.title("🧪 Mindent-bele Teszt")
if st.button("Feltöltés indítása"):
